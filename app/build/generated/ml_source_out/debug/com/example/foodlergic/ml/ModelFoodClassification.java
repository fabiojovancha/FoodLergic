package com.example.foodlergic.ml;
...
public final class ModelFoodClassification {
  @NonNull
  private final Model model;

  private ModelFoodClassification(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "model_food_classification.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static ModelFoodClassification newInstance(@NonNull Context context) throws IOException {
    return new ModelFoodClassification(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static ModelFoodClassification newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new ModelFoodClassification(context, options);
  }
